...
Object.registerClass("SliderV3forLat",SliderV3Class);
...
p.setMin = function(arg)
{
   ...
   if(isFinite(_loc2_))
   {
      _loc1_._min = _loc2_;
      _loc1_._scale = (_loc1_._max - _loc1_._min) / (2 * _loc1_._hw);
      _loc1_._minLabel.labelText = Math.abs(_loc1_._min) + "° S";
   }
};
...
p.setMax = function(arg)
{
   ...
   if(isFinite(_loc2_))
   {
      _loc1_._max = _loc2_;
      _loc1_._scale = (_loc1_._max - _loc1_._min) / (2 * _loc1_._hw);
      _loc1_._maxLabel.labelText = _loc1_._max + "° N";
   }
};
...
p.setValue = function(arg)
{
   ...
   if(isFinite(_loc3_))
   {
      ...
      if(_loc1_._prec > 0)
      {
         if(_loc1_.toFixed(_loc1_._value) < 0)
         {
            var direct = " S";
         }
         else if(_loc1_.toFixed(_loc1_._value) > 0)
         {
            var direct = " N";
         }
         else
         ...
         _loc1_._valueLabel.labelText = Math.abs(_loc1_.toFixed(_loc1_._value)) + "°" + direct;
      }
      else
      {
         if(_loc1_._value > 0)
         ...
         _loc1_._valueLabel.labelText = Math.abs(_loc1_._value) + "°" + direct;
      }
      _loc1_.positionSlider();
   }
};
